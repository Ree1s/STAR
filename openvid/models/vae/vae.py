...
class VideoAutoencoderKL(nn.Module):
    def __init__(self, from_pretrained=None, micro_batch_size=None):
        super().__init__()
        self.module = AutoencoderKL.from_pretrained(from_pretrained,  cache_dir="/group/ossdphi_algo_scratch_14/sichegao/checkpoints")
...
class VideoAutoencoderKLTemporalDecoder(nn.Module):
    def __init__(self, from_pretrained=None):
        super().__init__()
        self.module = AutoencoderKLTemporalDecoder.from_pretrained(from_pretrained,  cache_dir="/group/ossdphi_algo_scratch_14/sichegao/checkpoints")
        self.out_channels = self.module.config.latent_channels
        self.patch_size = (1, 8, 8)
