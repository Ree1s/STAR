...
class T5Embedder:
    ...
    def __init__(
        ...
        *,
        cache_dir="/group/ossdphi_algo_scratch_14/sichegao/checkpoints",
        hf_token=None,
        ...
        self.cache_dir = "/group/ossdphi_algo_scratch_14/sichegao/checkpoints"
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(from_pretrained, cache_dir=self.cache_dir)
        self.model = T5EncoderModel.from_pretrained(from_pretrained, cache_dir=self.cache_dir, **t5_model_kwargs).eval()
