...
export HIP_VISIBLE_DEVICES=0,1,4,5,6,7
...
torchrun --nnodes=1 --nproc_per_node=6 video_super_resolution/scripts/train_ddp.py --config configs/star/train/16x256x256.py
# export RANK=0
# export WORLD_SIZE=1
# export LOCAL_RANK=0
